...
import com.whatsmedia.ttia.enums.StoreOffers;
...
public class StoreOffersRecyclerViewAdapter extends RecyclerView.Adapter<StoreOffersRecyclerViewAdapter.ViewHolder> {
    private final static String TAG = StoreOffersRecyclerViewAdapter.class.getSimpleName();

    private List<StoreOffers> mItems = StoreOffers.getPage();
    private Context mContext;
    private IOnItemClickListener mListener;

    public StoreOffersRecyclerViewAdapter(Context context) {
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        StoreOffers item = StoreOffers.getItemByTag(mItems.get(position));
        if (item == null) {
