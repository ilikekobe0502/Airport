...
public class AirportSecretaryRecyclerViewAdapter extends RecyclerView.Adapter<AirportSecretaryRecyclerViewAdapter.ViewHolder> {
    private final static String TAG = AirportSecretaryRecyclerViewAdapter.class.getSimpleName();
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        AirportSecretary item = AirportSecretary.getItemByTag(mItems.get(position));
        if (item == null) {
