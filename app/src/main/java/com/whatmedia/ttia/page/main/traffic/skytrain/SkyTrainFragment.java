...
public class SkyTrainFragment extends BaseFragment implements SkyTrainContract.View {
    private static final String TAG = SkyTrainFragment.class.getSimpleName();
    ...
    private SkyTrainContract.Presenter mPresenter;

    public SkyTrainFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static SkyTrainFragment newInstance() {
        SkyTrainFragment fragment = new SkyTrainFragment();
...
//            mParam1 = getArguments().getString(ARG_PARAM1);
    ...
    @Override
    public void getSkyTrainFailed(final String message) {
        Log.d(TAG, message);
        mLoadingView.goneLoadingView();
        mMainActivity.runOnUI(new Runnable() {
            @Override
